...
@Named(value="ConsultaEspecificaAlternativaBean")
@SessionScoped
public class ConsultaEspecificaAlternativaBean implements Serializable {
    ...
    public ConsultaEspecificaAlternativaBean() {
    }
