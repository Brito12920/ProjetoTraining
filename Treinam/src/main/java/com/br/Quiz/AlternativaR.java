 ...
 * @author v103760
 */
public class AlternativaR implements Serializable{
    ...
    public String getRespondeuA() {
        return respondeuA;
    }

    public void setRespondeuA(String respondeuA) {
        this.respondeuA = respondeuA;
    }

    public String getRespondeuB() {
        return respondeuB;
    }

    public void setRespondeuB(String respondeuB) {
        this.respondeuB = respondeuB;
    }

    public String getRespondeuC() {
        return respondeuC;
    }

    public void setRespondeuC(String respondeuC) {
        this.respondeuC = respondeuC;
    }

    public String getRespondeuD() {
        return respondeuD;
    }

    public void setRespondeuD(String respondeuD) {
        this.respondeuD = respondeuD;
    }

    public String getRespondeuE() {
        return respondeuE;
    }

    public void setRespondeuE(String respondeuE) {
        this.respondeuE = respondeuE;
    }

    public String getRespondeuF() {
        return respondeuF;
    }

    public void setRespondeuF(String respondeuF) {
        this.respondeuF = respondeuF;
    }

    public String getRespondeuG() {
        return respondeuG;
    }

    public void setRespondeuG(String respondeuG) {
        this.respondeuG = respondeuG;
    }

    public String getRespondeuH() {
        return respondeuH;
    }

    public void setRespondeuH(String respondeuH) {
        this.respondeuH = respondeuH;
    }
    ...
    public String getRespondeuJ() {
        return respondeuJ;
    }

    public void setRespondeuJ(String respondeuJ) {
        this.respondeuJ = respondeuJ;
    }
    ...
    public void setUnidade(String unidade) {
      ...
      private String respondeuA;
      private String respondeuB;
      private String respondeuC;
      private String respondeuD;
      private String respondeuE;
      private String respondeuF;
      private String respondeuG;
      private String respondeuH;
      private String respondeu;
      private String respondeuJ;
