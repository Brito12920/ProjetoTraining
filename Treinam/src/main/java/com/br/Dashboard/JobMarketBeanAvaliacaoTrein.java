...
@ManagedBean
public class JobMarketBeanAvaliacaoTrein {
   ...
   public static String unit;
    ...
    public static void setUnit(String unit) {
        JobMarketBeanAvaliacaoTrein.unit = unit;
    }
  ...
  public void init() {
     ...
     for(int i=0;i < ListaAvaliacao.size();i++){
          try {
              ...
              Logger.getLogger(JobMarketBeanAvaliacaoTrein.class.getName()).log(Level.SEVERE, null, ex);
          }
     }
...
//      model.set("Perl", 14);
      ...
      model.setTitle(ano+" Indíce de avaliação do Treinamento"+TotalGeral);
  ...
  public PieChartModel getModel() {
   ...
   public int Pontuacao(String aval) throws SQLException{
        ...
        avaliacao = con.carregarAvaliacaoUnidade2(aval,"treinamento",JobMarketBeanAvaliacaoTrein.unit); 
...
//           } 
   ...
   public void carregar(){
        ...
        for(Avaliacao resultados:avaliacao){
                ...
                ListaAvaliacao.add(resultados.getTreinamento()); 
