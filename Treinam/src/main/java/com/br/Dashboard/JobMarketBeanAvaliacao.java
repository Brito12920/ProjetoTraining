...
@ManagedBean
public class JobMarketBeanAvaliacao {
...
//      model.set("Perl", 14);
      ...
      model.setTitle(ano+" Avaliações "+TotalGeral);
  ...
  public PieChartModel getModel() {
   ...
   public int Pontuacao(String aval) throws SQLException{
        ...
        avaliacao = con.carregarAvaliacaoUnidade2(aval,"avaliacao",this.getUnidade()); 
...
//           } 
   ...
   public void carregarGrafico(){
       JobMarketBeanAvaliacaoCat cat = new JobMarketBeanAvaliacaoCat();
       JobMarketBeanAvaliacaoTrein trein = new JobMarketBeanAvaliacaoTrein();
       ChartView chat = new ChartView();
       JobMarketBeanAvaliacaoCat.setUnit(unidade);
       JobMarketBeanAvaliacaoTrein.setUnit(unidade);
       ChartView.setUnit(unidade);
       this.init();
       cat.init();
       trein.init();
       chat.init();
